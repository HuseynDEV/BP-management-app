...
const Emails = () => {
    const datas = [
        ...
        { name: "Teymur Mehdiyev", position: "AFF Base Manager", linkedin: "linkedin.com/in/teymur-mehdiyev-92547a2b" },
        { name: 'Qahraman Valiyev', position: "Base Manager Assistant", linkedin: "linkedin.com/in/gahraman-valiyev-300102149" },
        { name: 'Zaur Rahimov', position: "Health Safety Environment Coordinator", email: 'zaur.rahimov@hotmail.com' },
        { name: "Ziya Agabalayev", position: "Health Safety Environment Coordinator", linkedin: "linkedin.com/in/ziya-agabalayev-ba1441b0" },
